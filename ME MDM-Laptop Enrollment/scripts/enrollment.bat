...
echo.
%EXE_PATH% -a "library.peb1106@mbs.edu.my" "ce9dffd55fbe96c9df449da519f303f0" "wSsVR60j%%2Fx%%2BjWPsvzjP4I7s7zAgHVgv1E0origGm73L9T%%2FDCocc7lUDKVw%%2FyH6QdFjY4EWAaoe8ryU8BgGIPh44pww5UWiiF9mqRe1U4J3x19urplTDDV2o%%3D" "mdm.manageengine.com" "443" "149057000000102025">%LOG_FILE_PATH% 2>&1 && (
  goto success
) || (
	goto check
)
...
echo.
%EXE_PATH% -f "library.peb1106@mbs.edu.my" "ce9dffd55fbe96c9df449da519f303f0" "wSsVR60j%%2Fx%%2BjWPsvzjP4I7s7zAgHVgv1E0origGm73L9T%%2FDCocc7lUDKVw%%2FyH6QdFjY4EWAaoe8ryU8BgGIPh44pww5UWiiF9mqRe1U4J3x19urplTDDV2o%%3D" "mdm.manageengine.com" "443" "149057000000102025" >%LOG_FILE_PATH% 2>&1  && (
	goto success
) || (
	goto failure
)
