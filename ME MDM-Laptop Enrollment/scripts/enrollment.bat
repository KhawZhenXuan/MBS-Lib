...
echo.
%EXE_PATH% -a "mbsdigitallibrary@gmail.com" "cbcafcf39f2b2f4d81e4f688ff116b2b" "wSsVR61y8xLyD%%2F8onDWvce0wn1sEBlqlREgv21Sg6iX1H%%2F7Cpcdpk0fMUQekG%%2FkaF2A%%2FRmRD8rwtmh0C0WVaj9glmVoADSiF9mqRe1U4J3x1rOq8wjfLVjw%%3D" "mdm.manageengine.com" "443" "148230000000102025">%LOG_FILE_PATH% 2>&1 && (
  goto success
) || (
	goto check
)
...
echo.
%EXE_PATH% -f "mbsdigitallibrary@gmail.com" "cbcafcf39f2b2f4d81e4f688ff116b2b" "wSsVR61y8xLyD%%2F8onDWvce0wn1sEBlqlREgv21Sg6iX1H%%2F7Cpcdpk0fMUQekG%%2FkaF2A%%2FRmRD8rwtmh0C0WVaj9glmVoADSiF9mqRe1U4J3x1rOq8wjfLVjw%%3D" "mdm.manageengine.com" "443" "148230000000102025" >%LOG_FILE_PATH% 2>&1  && (
	goto success
) || (
	goto failure
)
